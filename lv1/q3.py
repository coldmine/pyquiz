...
question = """이번에는 두 캐릭터가 맞붙어 자동으로 싸우는 시스템을 개발하고 있습니다.
두 캐릭터의 각각 다음 공격까지 남은 시간을 받아 다음번 공격까지 남은 시간과 공격자를 반환하세요.
첫번째 캐릭터가 공격하면 0, 두번째 캐릭터가 공격하면 1을 반환하면 됩니다.

다음공격(캐릭터1의남은시간, 캐릭터2의남은시간) => (다음공격까지남은시간, 공격자)
"""
